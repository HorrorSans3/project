 ...
 "How many months are there in a year?",
	...
	function question() {
		...
		document.getElementById('A').onclick = function() {
			document.getElementById('quest').innerHTML = questions[1];
			...
			document.getElementById('B').onclick = function(){
				document.getElementById('quest').innerHTML = questions[2];
				...
				document.getElementById('B').onclick = function(){
					document.getElementById('quest').innerHTML = questions[3];
					...
					document.getElementById('A').onclick = function(){
						document.getElementById('quest').innerHTML = questions[4]
